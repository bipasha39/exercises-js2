...
// only task 2 but for task 2 and 3 together use p.remove
...
//get the values ​​of the inputs
  ...
  const newMovie = createMovieObject(title, director, type, haveWatched); //are the 4 variables shown in the movie object
  addMovies(newMovie);
